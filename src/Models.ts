export default {
  ...
  characters: {
    ...
    // },
    frostie: {
      glb: require("../assets/models/characters/yeti/frostie.glb"),
    },
    blizzard: {
      glb: require("../assets/models/characters/yeti/blizzard.glb"),
    },
    glacier: {
      glb: require("../assets/models/characters/yeti/glacier.glb"),
    },
    // avocoder: {
