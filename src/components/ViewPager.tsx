...
class ViewPager extends Component {
  ...
  get node() {
    ...
    // React Native < 0.62 wraps in Animated component and needs getNode()
    // Newer versions expose scrollToIndex directly on the ref
    return this.list.getNode ? this.list.getNode() : this.list;
  }
